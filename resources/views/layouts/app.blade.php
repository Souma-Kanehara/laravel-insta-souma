...
<head>
    ...
    {{-- Stylesheet / CSS     asset means  -> public folder --}}
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-lableledby="account-dropdown">
                                    {{-- admin control button here --}}
                                    @can('admin')
        ...
        <main class="py-5">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    {{-- HTTP Requests with using routes --}}
                    {{-- ex:)http://localhost/post/4/show         ---> using regular routes (not an admin) --}}
                    {{-- ex:)http://localhost/admin/users         ---> admin route--}}
                    {{-- ex:)http://localhost/admin/              ---> regular routes (not an admin)--}}
                    {{-- ex:)http://localhost/admin/5/update      ---> admin routes --}}

                    {{-- web.php --}}
                    {{-- prefix: admin/users, damin/posts,admin/categories --}}
